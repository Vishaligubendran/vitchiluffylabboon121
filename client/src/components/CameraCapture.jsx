...
export default function CameraCapture({ open, onClose, onCapture, facingMode = 'environment' }) {
    ...
    <div className="camera-overlay" role="dialog" aria-modal="true" aria-label="Take photo">
      <div className="camera-panel">
        ...
        <div className="camera-actions">
          <button type="button" className="btn-secondary" onClick={() => { stopStream(); onClose(); }}>
            Cancel
          </button>
          <button
            type="button"
            className="btn-blue camera-capture-btn"
